...
/*   Updated: 2023/03/13 14:35:08 by absalhi          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
	...
	{
		std::cout << GREEN << "Randomness: " << RESET << std::endl;
		Data *_data = new Data();
		Serializer _serializer;
		uintptr_t _raw = _serializer.serialize(_serializer.deserialize(_serializer.serialize(_data)));
		Data *_data2 = _serializer.deserialize(_serializer.serialize(_serializer.deserialize(_raw)));
		std::cout << "data: " << _data << std::endl;
		std::cout << "data2: " << _data2 << std::endl;
	}
	return 0;
